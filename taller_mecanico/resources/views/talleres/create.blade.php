...
<div class="container">
    ...
    <form action="{{ route('talleres.store') }}" method="POST">
        ...
        <div class="mb-3">
            <label>Horario</label>
            <input type="text" name="horario" class="form-control" value="{{ old('horario') }}" required>
        </div>
        ...
        <div class="mb-3">
            <label>Latitud</label>
            <input type="text" name="latitude" id="lat" class="form-control" value="{{ old('latitude') }}" required>
        </div>

        <div class="mb-3">
            <label>Longitud</label>
            <input type="text" name="longitude" id="lng" class="form-control" value="{{ old('longitude') }}" required>
        </div>
